...
#pragma warning restore EF1002
            ...
            var columns = new[]
            {
                ...
                ("TokenCollectionEntries", "ScryfallId",   "TEXT NOT NULL DEFAULT ''"),
                ("PlanarCollectionEntries", "ScryfallId",   "TEXT NOT NULL DEFAULT ''"),
                ("SchemeCollectionEntries", "ScryfallId",   "TEXT NOT NULL DEFAULT ''"),
                ("VanguardCollectionEntries", "ScryfallId",   "TEXT NOT NULL DEFAULT ''"),
                ("ConspiracyCollectionEntries", "ScryfallId",   "TEXT NOT NULL DEFAULT ''"),
                ("ArtSeriesCollectionEntries", "ScryfallId",   "TEXT NOT NULL DEFAULT ''"),
